...
namespace Tarea12_MultiplosDe10SumaConteo
{
    class Tarea12
    {
        ...
        static private void conteoSumaMultiplos10()
        {
            ...
            while (i <= numero)  //Mientras i sea menor o igual a numero, se realizará lo siguiente:
            {
                ...
                i = i + 10;  //Se sumará (+ 10) al valor acumulado de i, para generar múltpiplos de 10
                conteo = conteo + 1;  //Amacenará las veces que el ciclo while se repita, sumando (+ 1) cada vez que se repita el ciclo.
            }

            Console.WriteLine("Hay un total de: " + conteo + " múltplos de 10");  //Mostrará en pantalla el total de multiplos de 10 que existen.
            Console.WriteLine("La suma total de los " + conteo + " múltiplos de es es de: " + suma);  //Mostrará en pantalla la suma de los múltiplos de 10.
        }
    }
}
